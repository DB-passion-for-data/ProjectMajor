...
unit_number = st.number_input("Enter unit_number")
cycle = st.number_input("Enter the ongoing cycle")
op1 = st.number_input("Enter the operational setting 1")
op2 = st.number_input("Enter the operational setting 2")
sm1= st.number_input("Sensor Measure 1")
sm2= st.number_input("Sensor Measure 2")
sm3= st.number_input("Sensor Measure 3")
sm4= st.number_input("Sensor Measure 4")
sm5= st.number_input("Sensor Measure 5")
sm6= st.number_input("Sensor Measure 6")
sm7= st.number_input("Sensor Measure 7")
sm8= st.number_input("Sensor Measure 8")
sm9= st.number_input("Sensor Measure 9")
sm10= st.number_input("Sensor Measure 10")
